# Generated by Django 5.1.4 on 2025-01-24 05:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='WaterQualityAnalysisRequestStatus',
            fields=[
        ...
        migrations.CreateModel(
            name='WaterQualityAnalysisMLModel',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('ml_model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.mlmodel')),
                ('water_quality_analysis', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.waterqualityanalysis')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='WaterQualityAnalysisRequest',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('water_quality_analysis', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.waterqualityanalysis')),
                ('water_quality_analysis_request_status', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='api.waterqualityanalysisrequeststatus')),
            ],
            options={

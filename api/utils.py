...
def generate_intensity_map(
    coordinates_json, raster_path, min_value, max_value, parameter_name, date
):
    try:
        ...
        Map = folium.Map(
            location=[center[1], center[0]], zoom_start=10, control_scale=True
        )
        ...
        with rasterio.open(raster_path) as src:
            ...
            raster_bounds_wgs84 = transform_bounds(
        ...
        folium.raster_layers.ImageOverlay(
            ...
            bounds=[
                [raster_bounds_wgs84[1], raster_bounds_wgs84[0]],

...
class ReservoirParameterModelScalerSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ReservoirParameterModelScaler
        fields = [
            "id",
            "reservoir",
            "parameter",
    ...
    def create(self, validated_data):
        ...
        instance = ReservoirParameterModelScaler.objects.create(
            **validated_data
        )
        ...
        scaler_filename = (
            f"scaler_{instance.reservoir.id}_"
            + f"{instance.parameter.id}{scaler_ext}"
        )

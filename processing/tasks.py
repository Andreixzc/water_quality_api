   ...
   try:
       ...
       for image_path in downloaded_files:
            try:
                ...
                # Get the date part (everything after the last occurrence of '_')
                
                
                #date_part = filename_without_ext.split('_')[-1]  # This gets '2022-01-12'
       ...
       for index, model in enumerate(models, 1):
           ...
           for image_path in downloaded_files:
               try:
                   ...
                   # Create AnalysisMachineLearningModel record for this specific image and model
